(function($) {
    ...
    $(document).ready(function() {
        $('#open-pickpack-button').on('click', function(e) {
            e.preventDefault();
            open_pickpack_popup();
        });
	
        $('#pickpack-popup .pickpack-close, #pickpack-popup .pickpack-overlay, #pickpack-popup .pickpack-cancel').on('click', function(e) {
            e.preventDefault();
            close_pickpack_popup(); 
        });
	
        $('#pickpack-popup .pickpack-add').on('click', function(e) {
            e.preventDefault();
        ...
        $('#pickpack-popup .pickpack-howto-toggle').on('click', function() {
