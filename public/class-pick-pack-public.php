...
class Pick_Pack_Public
{
     ...
     *
     * @param object $related_posts The related posts.
     ...
     * @access private
     * 
     * @return string Return the pick pack product key in woocommerce cart.
     */
     ...
     * @access public
     * 
     * @return array The updated woocommerce fragments.
     */
