(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#category-header-add').click(function () {

            $("#category-form").append(categories_string);
        });

        $(document).on('click', '.category-remove-button', function (event) {

            $(this).parent('.point-allocator-container').remove();
        });

        $('#multiple-category-product-add').click(function () {
        ...
        $(document).on('click', '.multiple-category-product-remove', function (event) {

            $(this).parent('.selected-product-row').remove();
        });

        $("#split-payment-checkbox").change(function () {
